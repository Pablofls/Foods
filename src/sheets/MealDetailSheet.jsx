// MealDetailSheet.jsx — detalle de comida + botón de editar.
...
export function MealDetailSheet({ mealId, mealById, onClose, onToggleFav, onDelete, onPlanToday, onEdit }) {
      ...
      <div style={{ marginTop: -1, background: 'var(--cream)', border: '1px solid var(--line-soft)', borderTop: 'none', borderRadius: '0 0 18px 18px', padding: '16px', marginBottom: 16 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 4, flexShrink: 0 }}>
            {/* Botón editar */}
            <button onClick={() => { onClose(); onEdit(meal); }} aria-label="Editar" style={{ border: 'none', background: 'var(--blue-soft)', borderRadius: 10, width: 34, height: 34, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: 'var(--blue-deep)' }}>
              <Icon name="edit" size={17} sw={1.8} stroke="var(--blue-deep)" />
            </button>
            ...
            <>
              ...
              {meal.ingredients.length > 0 && (
                <div style={{ marginTop: 12 }}>
                  <div style={{ fontFamily: 'var(--sans)', fontSize: 12, fontWeight: 700, letterSpacing: 0.6, textTransform: 'uppercase', color: 'var(--ink-40)', marginBottom: 9 }}>Lo que hemos pedido</div>
