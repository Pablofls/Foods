...
select * from (values
  ...
  ('Sopa de fideo',            'Sopa',        array['Fideo','Jitomate','Caldo de pollo','Cebolla'],                      false, 10, current_date - 6),
  ('Caldo de pollo con verduras','Sopa',      array['Pollo','Zanahoria','Calabaza','Chayote','Arroz'],                   false, 5,  current_date - 14),
  ('Pescado empapelado',       'Pescado',     array['Filete de pescado','Jitomate','Cebolla','Limón','Mantequilla'],     false, 3,  current_date - 20),
  ('Chiles rellenos',          'Vegetariano', array['Chile poblano','Queso','Huevo','Jitomate','Harina'],                false, 4,  current_date - 18),
  ('Tacos dorados de papa',    'Antojito',    array['Tortillas','Papa','Lechuga','Crema','Queso'],                       true,  6,  current_date - 9),
  ('Fajitas de pollo',         'Pollo',       array['Pechuga de pollo','Pimiento','Cebolla','Tortillas'],                false, 7,  current_date - 4),
  ('Calabacitas con queso',    'Vegetariano', array['Calabaza','Elote','Jitomate','Queso','Cebolla'],                    false, 5,  current_date - 11),
  ('Bistec encebollado',       'Res',         array['Bistec de res','Cebolla','Papa','Salsa de soya'],                   false, 6,  current_date - 7),
  ('Lentejas',                 'Sopa',        array['Lentejas','Tocino','Plátano macho','Jitomate'],                     false, 4,  current_date - 16),
  ...
  ('Sopa de tortilla',         'Sopa',        array['Tortilla','Jitomate','Chile pasilla','Aguacate','Queso'],           false, 5,  current_date - 15),
